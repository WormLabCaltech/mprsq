...
\newcommand{\fogn}{2091}
\newcommand{\total}{3,2XXXX} % Needs review!!!!
% \newcommand{\inall}{53}
% \newcommand{\allup}{10}
...
(141--795 genes). Given the similar overlaps between known interactors and an
...
from which we speculated that \eglp{} would have increased activity in the \hif{} mutant
...
in the same direction between the \eglhif{} and \egl{} (and \rhy{}) mutants.
