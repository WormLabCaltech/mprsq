...
% To reconstruct this pathway, we
...
%
% Transcriptomes can be understood as information-rich phenotypes~\cite{Wagner2016}.
% As transcriptomes have become more prominent, the single-cell community in
% particular has begun to use them to define and understand cellular
% identities~\cite{Singer2016,Adamson2016}. However, most approaches rely on
