...
of the phenotypes of the single mutants that make up its genotype. Epistatic
...
gene pair. We also generated models for the epistatic cases mentioned above using
...
W. K. for permission to cite? }Here, we draw multiple, varied lines
