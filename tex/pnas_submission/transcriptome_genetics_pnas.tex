...
With new genome engineering tools, generating mutants is now easy and fast for
many organisms. As a result, the bottleneck towards understanding gene function
is identifying their phenotypes and genetic interactions. Transcriptome
profiling by RNA sequencing measures the expression levels of all the genes in
an organism in a single experiment. For this reason, there is widespread
interest in using transcriptomic profiles as phenotypes for genetic analysis,
but the concept of epistasis, necessary to establish genetic interaction between
two genes, is not firmly established for multidimensional measurements. We show
how to accurately reconstruct genetic interactions between genes using
transcriptome profiling, and we introduce and formalize the concept of
