...
Additionally, until recently it has been hard to envision how to quantify
...
an organismal, as opposed to cellular, context.
}
...
in double mutants. Interpreting these high-dimensional measurements is
unintuitive. We developed a single coefficient to quantify transcriptome-wide
...
support aerobic metabolism. The Hypoxia Inducible Factors (HIFs) are an
...
\begin{figure}[tbhp]
  ...
  \caption{
    ...
    mutants. Shown are a random selection of 15 the \hifohtargets{} genes for
...
sequencing. We thank Hillel Schwartz,
Jonathan Liu, Han Wang, and Porfirio Quintero for helpful discussion.
