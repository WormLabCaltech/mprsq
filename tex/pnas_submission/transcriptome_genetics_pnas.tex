...
over \gene{vhl-1} for this class of genes.
...
information on iron concentration in the cell to determine binding to the
\ftna{} promoter, but could not definitively establish a mechanism. It is
...
did not decreases in \gene{hif-1} level in \egl{}, \rhy{} or \vhl{} mutants.
...
the amount of this \hifp{}-hydroxyl, in spite of loss of \gene{vhl-1} function
...
non-hydroxylated \hifp{} and promoting gene activity. Whether deletion of \hif{}
...
adults were picked and placed in 100 \si{\micro\liter} of TE pH 8.0 (Ambion AM
9849) in $0.2$ \si{\milli\liter} PCR tubes on ice. Worms were allowed to
...
\si{\micro\liter} RNA Secure (Ambion AM 7005). RNA samples were then taken up in
