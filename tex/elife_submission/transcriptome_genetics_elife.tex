...
class of 31 genes that have opposing changes in expression in \egl{} and \vhl{}
but the \eglvhl{} mutant has the same phenotype as \egl{}. These changes violate
the classical model of HIF-1 regulation, but can be explained by postulating a
...
relatively few genes having more. We have opted for this method of referring to
...
\textbf{A}. After sequencing, reads are quantified using Kallisto. Differential
